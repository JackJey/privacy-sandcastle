...
const SWRConfig = (props)=>{
    ...
    const [cacheContext] = (0,react_.useState)(()=>provider ? initCache(provider(extendedConfig.cache || cache), config) : UNDEFINED);
...
const useSWRHandler = (_key, fetcher, config)=>{
    ...
    const cached = (0,shim.useSyncExternalStore)((0,react_.useCallback)((callback)=>subscribeCache(key, (prev, current)=>{
