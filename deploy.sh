...
for host in $hosts; do
  ...
  ## change project
  npx --package firebase-tools firebase -c docker-compose/servers/${host}/firebase.json use ${host}
  ## deploy
  npx --package firebase-tools firebase -c docker-compose/servers/${host}/firebase.json deploy
done